...
(function($) {
  ...
  $(document).ready(function(){
    ...
    let old = '';
  $('*[data-timepicker]').on( "keyup",function(){
    let ch = $(this).val().split('');;

    let fx = 0;
    ch.forEach(function(it,key){
  ...
  $('*[data-timepicker]').attr('autocomplete','off').keydown(function(e){
    ...
    */
    ...
    /*
    let ch = inputValue;
    if (ch=="ㄅ"||ch=="ㄆ"||ch=="ㄇ"||ch=="ㄈ"||ch=="ㄉ"||ch=="ㄊ"||ch=="ㄋ"||ch=="ㄌ"||ch=="ㄍ"||ch=="ㄎ"||ch=="ㄏ"||ch=="ㄐ"||ch=="ㄑ"||ch=="ㄒ"||ch=="ㄓ"||ch=="ㄔ"||ch=="ㄕ"||ch=="ㄖ"||ch=="ㄗ"||ch=="ㄘ"||ch=="ㄙ"||ch=="一"||ch=="ㄨ"||ch=="ㄩ"||ch=="ㄚ"||ch=="ㄛ"||ch=="ㄜ"||ch=="ㄝ"||ch=="ㄞ"||ch=="ㄟ"||ch=="ㄠ"||ch=="ㄡ"||ch=="ㄢ"||ch=="ㄣ"||ch=="ㄤ"||ch=="ㄥ"||ch=="ㄦ"){
      console.log('權行');
